class AppConstant {
  // Tạm thời sử dụng localhost để test
  static const String SERVER_API_URL = "http://192.168.1.104:8000/";
  static const String SERVER_UPLOADS = "${SERVER_API_URL}uploads/";
  static const String STORAGE_DEVICE_OPEN_TIME = 'deivice_first_open';
